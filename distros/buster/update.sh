...
apt update
apt dist-upgrade
apt install gnome-core chromium nano bash-completion git htop squashfs-tools net-tools curl wget code
apt install -t buster-backports nvidia-driver firmware-iwlwifi
apt autoremove
apt autoclean
